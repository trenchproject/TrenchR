#' @details Predicts body temperatures (operative environmental temperatures) of a butterfly.
#' @description Predicts body temperatures (operative environmental temperatures) of a butterfly. Based on Kingsolver (1983, Thermoregulation and flight in Colias butterflies: elevational patterns and mechanistic limitations. Ecology 64: 534–545). 
#' 
...
estimate_butterfly_Tb=function(Ta, Tg, Tg_sh, u, H_sdir, H_sdif, psi, D, delta, alpha, r_g=0.3){
