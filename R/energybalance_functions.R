...
#' 
#' @description Approximate saturation water vapor pressure as a function of ambient temperature for temperatures from 0 to 40C using Rosenberg 1974 in \insertCite{Spotile1992}{TrenchR}. See also NichMapR WETAIR and DRYAIR functions from \insertCite{Tracy1980}{TrenchR}.
#' 
