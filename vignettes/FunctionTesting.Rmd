...
```{r}
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "sphere")
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "cylinder")
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "frog")
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "lizard_surface")
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "lizard_elevated")
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "flyinginsect")
heat_transfer_coefficient(V=0.5,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "spider")
```

```{r}
heat_transfer_coefficient_approximation(V=3,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "sphere")
heat_transfer_coefficient_approximation(V=3,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "frog")
heat_transfer_coefficient_approximation(V=3,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "lizard")
heat_transfer_coefficient_approximation(V=3,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "flyinginsect")
heat_transfer_coefficient_approximation(V=3,D=0.05,K= 25.7 * 10^(-3),nu= 15.3 * 10^(-6), "spider")
```
...
Qevaporation(A=0.1, T_b=293, taxa="amphibian_wetskin", rho_s=1.2, rho_a=1.2, h=0.5, H=20, r_i=5000)
Qevaporation(A=0.1, T_b=293, taxa="lizard")
#NEED TO COMPARE TAXA
```
...
Qmetabolism_from_mass(m=12,"bird")
Qmetabolism_from_mass(m=12,"mammal")
```

```{r}
Qmetabolism_from_mass_temp(m=100, T_b=303,"bird")
Qmetabolism_from_mass_temp(m=100, T_b=303,"mammal")
Qmetabolism_from_mass_temp(m=100, T_b=303,"reptile")
Qmetabolism_from_mass_temp(m=100, T_b=303,"amphibian")
Qmetabolism_from_mass_temp(m=100, T_b=303,"invertebrate")
```
