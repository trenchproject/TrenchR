...
#CHECKED, Change to add next day temperatures for double methods
```
...
```{r}
Qevap= unlist(lapply(293:313, FUN=Qevaporation, A=0.1, taxa="amphibian_wetskin", rho_s=0.003, rho_a=0.002, h=0.5, H=20, r_i=50))
plot(293:313, Qevap, type="l", xlab = "body temperature (K)", ylab = "evaporative heat loss (W)", lty="dashed", ylim=c(0,10))
Qevap= unlist(lapply(293:313, FUN=Qevaporation, A=0.1, taxa="amphibian", rho_s=0.003, rho_a=0.002, h=0.5, H=20, r_i=50))
points(293:313, Qevap, type="l", lty="dotted")
Qevap= unlist(lapply(293:313, FUN=Qevaporation, A=0.1, taxa="lizard"))
points(293:313, Qevap, type="l")
#CHECKED, but needs further checking
```
...
#CHECK AGAINST EXAMPLE IN BOOK FOR PERSON
```
...
```{r}
t.seq= lapply(293:313, FUN=Tb_Gates, A=1, D=0.001, psa_dir=0.6, psa_ref=0.4, psa_air=0.6, psa_g=0.2, T_g=303, Qabs=400, epsilon=0.95, H_L=10, ef=1.3, K=0.5)
plot(293:313, t.seq, type = "l", xlab = "ambient temperature (C)", ylab = "body temperature (C)", xlim=c(295,315), ylim=c(295,315))
abline(a=0,b=1, lty="dotted")
#vary radiation
t.seq= lapply(seq(0,800,100), FUN=Tb_Gates, A=1, D=0.001, psa_dir=0.6, psa_ref=0.4, psa_air=0.6, psa_g=0.2, T_a=303, T_g=303, epsilon=0.95, H_L=10, ef=1.3, K=0.5)
plot(seq(0,800,100), t.seq, type = "l", xlab = "radiation absorbed (W)", ylab = "body temperature (C)")
...
abline(a=0,b=1, lty="dotted")
t.seq= lapply(seq(0,800,20), FUN=Tb_grasshopper, T_a=25, T_g=25, u=0.4, K_t=0.7, psi=30, L=0.02, Acondfact=0.25, z=0.001, abs=0.7, r_g=0.3)
plot(seq(0,800,20), t.seq, type = "l", xlab = "Direct radiation (W)", ylab = "body temperature (C)")
abline(a=25,b=0, lty="dotted")
```
...
#calculate_To
```{r}
t.seq= lapply(293:313, FUN=Tb_Fei, T_s=300, TAH=300, UDT=600, GLW=30, shade=0.5)
...
```{r}
require(deSolve) #fix dependencies
require(zoo)
# 
