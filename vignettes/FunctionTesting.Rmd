...
```{r}
plot(seq(0, 90, 10), prop_silhouette_area(z=seq(0, 90, 10), taxa= "frog"), type="l", xlab = "zenith angle (degree)", ylab = "proportion silhouette area", ylim=range(0,0.31))
points(seq(0, 90, 10), prop_silhouette_area(z=seq(0, 90, 10), taxa= "lizard", raz=0, posture="prostrate"), type="l")
points(seq(0, 90, 10), prop_silhouette_area(z=seq(0, 90, 10), taxa= "lizard", raz=0, posture="elevated"), type="l")
points(seq(0, 90, 10), prop_silhouette_area(z=seq(0, 90, 10), taxa= "grasshopper"), type="l")
```

```{r}
plot(seq(0, 90, 10), prop_silhouette_area_shapes(shape="spheroid", theta=seq(0, 90, 10), h=0.01, d=0.001), type="l", xlab = "theta (degree)", ylab = "proportion silhouette area")
points(seq(0, 90, 10), prop_silhouette_area_shapes(shape="cylinder flat ends", theta=seq(0, 90, 10), h=0.01, d=0.001), type="l", lty="dashed")
points(seq(0, 90, 10), prop_silhouette_area_shapes(shape="cylinder hemisphere ends", theta=seq(0, 90, 10), h=0.01, d=0.001), type="l", lty="dotted")
...
```{r}
Qevap= unlist(lapply(293:313, FUN=Qevaporation, A=0.1, taxa="amphibian_wetskin", rho_s=1.2, rho_a=1.2, h=0.5, H=20, r_i=5000))
plot(293:313, Qevap, type="l", xlab = "body temperature (K)", ylab = "evaporative heat loss (W)", lty="dashed", ylim=c(0,2))
Qevap= unlist(lapply(293:313, FUN=Qevaporation, A=0.1, taxa="amphibian", rho_s=1.2, rho_a=1.2, h=0.5, H=20, r_i=5000))
...
```{r}
plot(1:20, Qmetabolism_from_mass(m=1:20,"bird"), type="l", xlab = "mass(g)", ylab = "metabolism (W)", ylim=c(0,1))
points(1:20, Qmetabolism_from_mass(m=1:20,"mammal"), type="l", lty="dashed")
points(1:20, Qmetabolism_from_mass(m=1:20,"reptile"), type="l", lty="dotted")
```

```{r}
plot(1:20, Qmetabolism_from_mass_temp(m=1:20, T_b=303,"bird"), type="l", xlab = "mass (g)", ylab = "metabolism (W)", ylim=c(0,0.1))
points(1:20, Qmetabolism_from_mass_temp(m=1:20, T_b=303,"mammal"), type="l")
points(1:20, Qmetabolism_from_mass_temp(m=1:20, T_b=303,"reptile"), type="l")
points(1:20, Qmetabolism_from_mass_temp(m=1:20, T_b=303,"amphibian"), type="l")
points(1:20, Qmetabolism_from_mass_temp(m=1:20, T_b=303,"invertebrate"), type="l")

plot(293:313, Qmetabolism_from_mass_temp(m=5, T_b=293:313,"bird"), type="l", xlab = "mass (g)", ylab = "metabolism (W)", ylim=c(0,0.1))
...
```{r}
plot(20:40, actual_vapor_pressure(Tdewpoint=20:40), type="l", xlab = "dewpoint temperature (C)", ylab = "actual vapor pressure (kPa)")
```

```{r}
plot(293:313, saturation_vapor_pressure(T_a=293:313), type="l", xlab = "air temperature (K)", ylab = "saturation vapor pressure (kPa)")
```
...
```{r}
t.seq= lapply(20:40, FUN=Tb_salamander_humid, r_i=4,r_b=1,D=0.007,elev=500,e_a=2.5,e_s=2.3,Qabs=400, epsilon=0.96)
...
```{r}
plot(20:40, Qthermal_radiation_absorbed(T_a=20:40, epsilon_ground=0.97, a_longwave=0.965), type="l", xlab = "air temperature (C)", ylab = "thermal radiation absorbed (W)")
```
...
points(1:24, Tsoil(Tg_max=30, Tg_min=15, hour=1:24, depth=20), type="l")
```
...
```{r}
t.seq= lapply(293:313, FUN=Tb_Gates, A=1, D=0.001, psa_dir=0.6, psa_ref=0.4, psa_air=0.6, psa_g=0.2, T_g=303, Qabs=800, epsilon=0.95, H_L=10, ef=1.3, K=0.5)
...
```{r}
t.seq= lapply(20:40, FUN=Tb_grasshopper, T_g=25, u=0.4, H=400, K_t=0.7, psi=30, L=0.02, Acondfact=0.25, z=0.001, abs=0.7, r_g=0.3)
