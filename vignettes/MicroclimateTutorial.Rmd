...
The tutorial first covers estimating the intensity and partitioning of solar radiation, including estimating solar angles and day length. 
...
The equation for half day length $h_s$, which is the time (in degrees) from sunrise to solar noon, is used as the basis for our `daylength()` function:
