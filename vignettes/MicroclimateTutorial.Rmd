...
hrs=1:24
Thr= sapply(hrs, FUN=diurnal_temp_variation_sinesqrt, tr=Tr, ts=Ts, Tmx=Tmx, Tmn=Tmn,Tmn_p=Tmn) ##FIX
...
#soil_temperature(z.intervals=12,z=1.5, Tair=Thr, u_z=Vs, Tsoil0= 20, z0=z0, SSA=0.7, TimeIn=hrs, solrad= Qhr_tot, water_content=0.2, air_pressure=airpressures, rho_so=1620, shade=FALSE)
