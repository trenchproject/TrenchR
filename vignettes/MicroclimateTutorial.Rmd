...
where J is calendar date, $\phi$ is latitude (radians), h is hour, and $h_0$ is the time of solar noon. We illustrate how zenith angles (degrees) changes over the day throughout the year in Seattle, WA, USA:
...
z0= surface_roughness(u_r, zr)

plot(u_r, zr, type="l", ylim=c(0,1), xlim=c(0,0.2))
points(0, z0)
```
