...
|$k_{so}$| soil thermal conductivity ($W m^{-1}°K^{-1}$) ||
...
|$T$| temperature ($°C$ or $K$ or $°F$) (subscripts: $a$, air; $g$, ground; $s$, surface; $sh$, shade) ||
...
|$z$| distance, or height above a surface ($m$); zenith angle (°)||
