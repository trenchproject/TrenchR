...
```{r}
Te= rep(NA, 24)
for(hr in 1:24) Te[hr]= Tb_Gates(A=A, D=D, psa_dir=psa[hr], psa_ref=1-psa[hr], psa_air=0.67, psa_g=0.33, Tg=Ts[hr]+273, Ta=Ta[hr]+273, Qabs=Sdir[hr], epsilon=epsilon_s, H_L=H_L, ef=1.3, K=K)
#check T, Qabs
