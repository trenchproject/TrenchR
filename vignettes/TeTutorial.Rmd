...
We present a function 'Tb_salamand_humid' adapted from Riddell et al. 
...
$D$ is the vapor pressure deficit (kPa), and $p_{a}$ is the atmospheric pressure (kPa).
...
We provide the humid operative temperature model as follows.
