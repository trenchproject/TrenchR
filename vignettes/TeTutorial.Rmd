...
#FIX PSI, check Solar angle
t.seq <- lapply(20:40, FUN = Tb_limpetBH, T_r = 30, L = 0.0176, H = 0.0122, I = 1300, u = 1, s_aspect = 280, s_slope=60, c = 1, position = "anterior")
points(20:40, t.seq, type = "l", lty = "dashed")
...
blr.seq= lapply(sqrt(5:20), FUN=boundary_layer_resistance, T_a=293, e_s=2.5, e_a=2.3, elev=500, u=2)
plot(sqrt(5:20), blr.seq, type = "l", xlab = "diameter (m)", ylab = expression("boundary layer resistance" ~ (s ~ cm^{-1})))
```


```{r, fig.height=4, fig.width=6}
t.seq= lapply(20:40, FUN=Tb_salamander_humid, r_i=4,r_b=1,D=0.01,elev=500,e_a=1.5,e_s=2.5,Qabs=400, epsilon=0.96)
...
t.seq= lapply(20:40, FUN=Tb_salamander_humid, r_i=20,r_b=1,D=0.01,elev=500,e_a=1.5,e_s=2.5,Qabs=400, epsilon=0.96)
points(20:40, t.seq, type = "l", col="red")

#check higher vpd-> lower Te due to greater cooling
t.seq= lapply(20:40, FUN=Tb_salamander_humid, r_i=4,r_b=1,D=0.01,elev=500,e_a=1.0,e_s=2.5,Qabs=400, epsilon=0.96)
