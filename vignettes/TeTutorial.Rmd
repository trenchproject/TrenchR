...
We calculate the surface area by approximating the body of a female grasshopper as a rotational ellipsoid (@samietz2005altitudinal).  The major axis is equal to the grasshopper’s length.  We calculate the semi-minor axis (half of the grasshopper’s width) as $a=(0.365+0.241*1000 L)/1000$ using a regression from Lactin and Johnson (1998). If $e=\sqrt{1-a^2/c^2}$, surface area can be calculated as follows:
