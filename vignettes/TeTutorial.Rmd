...
Lastly, $Q_{evap} = \lambda \dot{m}$ where $\lambda$ is the latent heat of vaporization of water (J/kg) and $\dot{m}$ is the rate of water loss (Helmuth 1998). For the purposes of this package, we set the value to zero to illustrate conditions when the mussel does not gape or otherwise cannot evaporatively cool.
