...
assume psa_dif = psa_dir. The functions `prop_silhouette_area()` and
`prop_silhouette_area_shapes()` provide assistance calculating the
...
modelling free or forced convection is appropriate. Forced convection is
...
conductance. Cambell and Norman [-@campbell2012introduction] thus use a
