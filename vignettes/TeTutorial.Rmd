...
Details are available in biophysical ecology texts [@gates2012biophysical; @campbell2012introduction]. We note that we have standardized the functions to accept and return temperatures in degrees C but the heat budget calculations generally use kelvin.
...
$T_a$ is additionally used to estimate sky temperature $T_{sky} (C)$, the effective radiant temperature of the sky as $T_{sky}= 1.22\times (T_a-273.15)-20.4+273.15$ [@gates2012biophysical]. 
...
plot(x    = 20:40, 
     y    = Qemitted_thermal_radiation(epsilon  = 0.96, 
                                       ...
                                       enclosed = FALSE), 
     type = "l", 
     xlab = "body surface temperature, Tb (C)", 
...
plot(x    = 20:40, 
     y    = Qconduction_animal(T_g        = 20:40,
                               ...
                               proportion = 0.2), 
     type = "l", 
     xlab = "ground temperature (C)", ylab = "Q conductance (W)")
