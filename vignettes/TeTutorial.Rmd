...
Te4= rep(NA, 24)
for(hr in 1:24) Te4[hr]= Tb_Fei(TAH=Ta[hr]+273, Tsurface=Ts[hr]+273, Tair=Ts[hr]+273, SWDOWN=Qabs[hr], GLW=Qabs[hr],  shade=0)


#' Tb_Fei(TAH=254, Tsurface=265, Tair=267, SWDOWN=15, GLW=307,  shade=0)
