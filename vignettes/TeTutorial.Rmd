...
```{r, fig.height=4, fig.width=6}
plot(293:313, Tb_CampbellNorman(T_a=293:313, T_g=303, S=600, alpha_L=0.96, epsilon=0.96, c_p=29.3, D=0.17, V=1), type="l", xlab = "air temperature (K)", ylab = "body temperature (K)", xlim=c(295,310), ylim=c(290,340))
abline(a=0, b=1, col="gray")

points(293:313, Tb_CampbellNorman(T_a=293:313, T_g=303, S=200, alpha_L=0.96, epsilon=0.96, c_p=29.3, D=0.17, V=1), type="l", lty="dashed")
points(293:313, Tb_CampbellNorman(T_a=293:313, T_g=303, S=400, alpha_L=0.96, epsilon=0.96, c_p=29.3, D=0.17, V=1), type="l", lty="dotted")
