...
Lastly, $Q_{evap} = \lambda \dot{m}$ where $\lambda$ is the latent heat of vaporization of water ($J/kg$) and $\dot{m}$ is the rate of water loss [@helmuth1998intertidal]. We use empirical measurements of maximum rates of water loss before dessication occures to model evaporation.
...
t.seq <- lapply(20:40, FUN = Tbed_mussel, S=500, k_d=0.2, u = 0.2, evap = FALSE)
plot(20:40, t.seq, type = "l", xlab = "ambient temperature (°C)", ylab = "body temperature (°C)", ylim = c(20, 50))

t.seq <- lapply(20:40, FUN = Tbed_mussel, S=500, k_d=0.2, u = 1, evap = FALSE)
points(20:40, t.seq, type = "l", lty = "dashed")

t.seq <- lapply(20:40, FUN = Tbed_mussel, S=500, k_d=0.2, u = 2, evap = FALSE)
points(20:40, t.seq, type = "l", lty = "dotted")

t.seq <- lapply(20:40, FUN = Tbed_mussel, S=500, k_d=0.2, u = 0.2, evap = TRUE)
