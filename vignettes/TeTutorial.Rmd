...
R code for a transient model of lizard body temperature is available in the following repository: https://github.com/JRubalcaba/BodyTemp.
...
```{r, fig.height=4, fig.width=6}
t.seq <- lapply(20:40, FUN = Tb_mussel, L = 0.1, H = 0.05, T_g = 30, S=500, k_d=0, u = 0.2, psi =60, evap = TRUE, cl = 0, group = "solitary")
...
t.seq <- lapply(20:40, FUN = Tb_mussel, L = 0.1, H = 0.05, T_g = 30, S=500, k_d=0, u = 2, psi =60, evap = TRUE, cl = 0, group = "solitary")
points(20:40, t.seq, type = "l", lty = "dotted")
...
We also illustrate how the model can be applied to investigate the effect of mussel size and evaporation. The red line indicates the effect of evaporative heat loss.
```{r, fig.height=4, fig.width=6}
...
TrenchR also provides a version two versions of the limpet model modified by the Helmuth Lab. The first modifies radiation and convection in the function for limpets: `Tb_limpetBH`. The second modifies the function to predict snail body temperatures `Tb_snail`.
